...
class SidebarHelper extends Helper {
    ...
    public function create($menuItems = null) {
        if (!empty($menuItems)) {
            ...
            <script>
                $(function () {
                    var _this = $('[id*="<?= $this->request->getParam('controller'); ?>"]');
                    ...
                    var _this = $('[id*="nav_<?= $this->request->getParam('controller') . $this->request->getParam('action'); ?>"]');
    ...
    public function menuItem($menuItem, $index) {
        ...
        <?php } else { ?>
            <?php $mainId = 'nav' . $index . '_' . $item['controller']; ?>
