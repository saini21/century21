...
<section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall "
    ...
    <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-black-opacity-0_3--after"
         style="height: 140%; background-image: url(<?= SITE_URL ?>/img/about-banner_v2.jpg);"></div>
    <!-- End Parallax Image -->
    
    <!-- Promo Block Content -->
    <div class="container g-color-white text-center g-py-120">
        <h3 class="h1 g-font-weight-600 text-uppercase mb-2">About</h3>
        <p class="g-font-weight-300 g-font-size-22 text-uppercase">20+ years’ experience in the Apartment Locating Industry</p>
    </div>
    <!-- Promo Block Content -->
</section>
<!-- End Promo Block -->
