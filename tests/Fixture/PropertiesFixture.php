...
class PropertiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_premium' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'is_featured' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'last_searched_at' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_premium' => 1,
                'is_featured' => 1,
                'last_searched_at' => '2019-02-23 05:40:31',
                'created' => '2019-02-23 05:40:31',
                'modified' => '2019-02-23 05:40:31'
            ],
        ];
        parent::init();
    }
