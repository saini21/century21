...
class CitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'state_code' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2019-02-23 05:39:07',
                'modified' => '2019-02-23 05:39:07'
            ],
        ];
        parent::init();
    }
