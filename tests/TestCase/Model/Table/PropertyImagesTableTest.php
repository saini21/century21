...
class PropertyImagesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('PropertyImages') ? [] : ['className' => PropertyImagesTable::class];
        $this->PropertyImages = TableRegistry::getTableLocator()->get('PropertyImages', $config);
    }
